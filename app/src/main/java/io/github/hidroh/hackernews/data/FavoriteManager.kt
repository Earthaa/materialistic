...
package io.github.hidroh.hackernews.data
...
import io.github.hidroh.hackernews.DataModule
import io.github.hidroh.hackernews.FavoriteActivity
import io.github.hidroh.hackernews.R
import io.github.hidroh.hackernews.ktx.closeQuietly
import io.github.hidroh.hackernews.ktx.getUri
import io.github.hidroh.hackernews.ktx.setChannel
import io.github.hidroh.hackernews.ktx.toSendIntentChooser
import okio.Okio
...
class FavoriteManager @Inject constructor(
  ...
  companion object {
    ...
    private const val FILENAME_EXPORT = "hackernews-export.txt"
    private const val FILE_AUTHORITY = "io.github.hidroh.hackernews.fileprovider"

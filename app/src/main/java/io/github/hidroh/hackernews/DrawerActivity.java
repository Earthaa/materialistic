    ...
    private void setUpDrawer() {
        ...
        findViewById(R.id.drawer_best).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClassName("io.github.hidroh.hackernews", "io.github.hidroh.hackernews.beststories.BestActivity");
                startActivity(intent);
        ...
        findViewById(R.id.drawer_show).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent();
                intent.setClassName("io.github.hidroh.hackernews", "io.github.hidroh.hackernews.showhn.ShowActivity");
                startActivity(intent);
        ...
        findViewById(R.id.drawer_ask).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent();
                intent.setClassName("io.github.hidroh.hackernews", "io.github.hidroh.hackernews.askhn.AskActivity");
                startActivity(intent);
        ...
        findViewById(R.id.drawer_job).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent();
                intent.setClassName("io.github.hidroh.hackernews", "io.github.hidroh.hackernews.module.JobsActivity");
                startActivity(intent);
